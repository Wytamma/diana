...
<AppShell>
  <svelte:fragment slot="header">
    <AppBar shadow="drop-shadow-lg">
      ...
      <svelte:fragment slot="trail">
        ...
        <a class="btn btn-sm hover:underline" href="/docs/" target="_blank" rel="noreferrer">
          Docs
        </a>
      </svelte:fragment>
    </AppBar>
  ...
  <svelte:fragment slot="sidebarLeft">
    <AppRail class="hidden md:block">
      <AppRailTile on:click={() => navigateTo('/')} bind:group={currentTile} value="/" name="data">
        <span>Data</span>
      </AppRailTile>
      <AppRailTile
        ...
        value="/annotations"
        name="annotations"
        class={!$annotationStore.filename
      ...
      <AppRailTile
        ...
        value="/tracks"
        name="tracks"
        class={!$annotationStore.filteredFeatures.length
          ? 'opacity-50 pointer-events-none cursor-not-allowed'
          : ''}
      >
        <span>Tracks</span>
      ...
      <AppRailTile
        ...
        value="/bias"
        name="bias"
        class={!$annotationStore.filteredFeatures.length || $insertStore.size === 0
          ? 'opacity-50 pointer-events-none cursor-not-allowed'
          : ''}
      >
        <span>Bias</span>
  ...
  <svelte:fragment slot="footer">
    ...
    >
      ...
      <TabAnchor
        on:click={() => navigateTo('/annotations')}
        selected={$page.url.pathname === '/annotations'}
        class={!$annotationStore.filteredFeatures.length
          ? 'opacity-50 pointer-events-none cursor-not-allowed'
          : ''}
      >
      ...
      <TabAnchor
        on:click={() => navigateTo('/tracks')}
        selected={$page.url.pathname === '/tracks'}
        class={!$annotationStore.filteredFeatures.length
          ? 'opacity-50 pointer-events-none cursor-not-allowed'
          : ''}
      >
      ...
      <TabAnchor
        on:click={() => navigateTo('/bias')}
        selected={$page.url.pathname === '/bias'}
        class={!$annotationStore.filteredFeatures.length || $insertStore.size === 0
          ? 'opacity-50 pointer-events-none cursor-not-allowed'
          : ''}
      >
      ...
      <TabAnchor
        on:click={() => navigateTo('/compare')}
        selected={$page.url.pathname === '/compare'}
        class={!$annotationStore.filteredFeatures.length || !$containsControlAndTreatment
          ? 'opacity-50 pointer-events-none cursor-not-allowed'
          : ''}
      >
        <span>Compare</span>
