...
var Module = (function () {
  ...
  return function (Module) {
    ...
    (function () {
      ...
      loadPackage({
        files: [
          { filename: '/samtools/examples/.gitignore', start: 0, end: 68, audio: 0 },
          { filename: '/samtools/examples/ex1.fa', start: 68, end: 3293, audio: 0 },
          { filename: '/samtools/examples/ex1.sam.gz', start: 3293, end: 117858, audio: 0 },
          { filename: '/samtools/examples/toy.fa', start: 117858, end: 117956, audio: 0 },
          { filename: '/samtools/examples/toy.sam', start: 117956, end: 118742, audio: 0 },
          { filename: '/samtools/examples/00README.txt', start: 118742, end: 120057, audio: 0 }
        ],
        remote_package_size: 120057,
        package_uuid: 'efa83d48-08b6-461d-90c9-812b89a230ea'
      });
    })();
    var moduleOverrides = {};
    var key;
    ...
    function _pthread_attr_getstacksize() {
      err('missing function: pthread_attr_getstacksize');
      abort(-1);
    }
    ...
    var asmLibraryArg = {
      ...
      popen: _popen,
      pthread_attr_getstacksize: _pthread_attr_getstacksize,
    ...
    var dynCall_iiijji = (Module['dynCall_iiijji'] = function () {
      return (dynCall_iiijji = Module['dynCall_iiijji'] = Module['asm']['dynCall_iiijji']).apply(
        null,
        arguments
      );
    });
